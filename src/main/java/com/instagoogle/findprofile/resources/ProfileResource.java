...
public class ProfileResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody ProfileDTO objDto) {
		Profile obj = service.fromDTO(objDto);
	...
	public ResponseEntity<Void> update(@Valid @RequestBody ProfileDTO objDto, @PathVariable Integer id) {
		Profile obj = service.fromDTO(objDto);
		obj.setId(id);
